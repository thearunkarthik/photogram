...
<head>
    ...
    <title>Cheems Doge App</title>
    <link rel="icon"  href="../app/assets/brand/cheems_favicon.jpg">
    <link
        rel="canonical"
        href="https://getbootstrap.com/docs/5.3/examples/album/" />
    <script src="/site/app/assets/js/color-modes.js"></script>
    <link href="/site/app/assets/dist/css/bootstrap.min.css" rel="stylesheet" />
...
<body>
    ...
    <main>
        ...
        <?
        moss_template(name: '__banner');
        ?>

        <?
        moss_template(name: '__album');
        ?>


    </main>
    <?
    moss_template('__footer');
    ?>
    <script
        src="/site/app/assets/dist/js/bootstrap.bundle.min.js"
